...
C++ object oriented software development skills.

The zip file contains source code for a program 
that processes a mixture of items.
The program is written using C style.

The program can be built and run using Microsoft Visual Studio (MSVS)
or by using standard linux tools.  
...
Your goal is to rewrite the program using a C++ object oriented style.
